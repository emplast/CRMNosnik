...
<head>
  ...
  <link rel="icon" href="../bower_components/Ionicons/png/512/hdd.png">
...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
        <img src="bower_components/Ionicons/png/512/hdd.png" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
<?php echo form_open('index.php/Welcome/login',array('class'=>'lockscreen-credentials'));?>
 ...
 <?php echo form_close();?>
  ...
  <div class="help-block text-center">
    Podaj logi i hasło i przejdź do swojej sesji
  </div>
  <div class="text-center">
      <a href="#">Witaj na naszych stronach</a>
  </div>
